...
console.log(sub_instance.private_super_prop);  // [1,2,3,4,5]  // error code
console.log(sub_instance.protected_super_prop);  // 'hello world'  // error code
...
console.log(sub_instance.private_sub_prop);  // 'an expression of greeting'  // error code
console.log(sub_instance.protected_sub_prop);  // ['Hello world', 'Hi, everyone.', 'Howdy, partner.']  // error code
