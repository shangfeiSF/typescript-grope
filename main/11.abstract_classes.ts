...
class Mobile extends Phone {
    ...
    protected boot(): Date {
        let date = new Date();
        console.log(`This mobile named ${this.name} has been rooted at ${date}`);
        return date;
    }

    open(): boolean {
        console.log(`This mobile named ${this.name} is opened.}`);
        return true;
    }
    ...
    restart() {
        this.open();
        this.boot();
        console.log(`This mobile named ${this.name} ha been restared.`)
    }
}
